...
public class CustomMachineScreen extends AbstractContainerScreen<ManaInfusingStationMenu> {


    private static final ResourceLocation TEXTURE =
            //TODO: change ResourceLocation
            new ResourceLocation(MagicProgression.MOD_ID,"textures/gui/mana_infusing_station.png");


    //TODO: change input parameter
    public CustomMachineScreen(CustomMachineMenu menu, Inventory inventory, Component component) {
    ...
    private void renderProgressArrow(PoseStack pPoseStack, int x, int y) {
        if(menu.isCrafting()) {
            //TODO: change positions, size and if necessary direction of arrow rendering
