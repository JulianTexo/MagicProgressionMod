...
public class ManaInfusingStationMenu extends AbstractContainerMenu {
    public final ManaInfusingStationBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public ManaInfusingStationMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public ManaInfusingStationMenu(int id, Inventory inv, BlockEntity entity, ContainerData data){
        super(ModMenuTypes.MANA_INFUSING_STATION_MENU.get(), id);
        checkContainerSize(inv, 4);
        blockEntity = (ManaInfusingStationBlockEntity) entity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.MANA_INFUSING_STATION.get());
    }
