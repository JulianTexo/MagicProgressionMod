...
public class ManaFurnaceMenu extends AbstractContainerMenu {
    ...
    public ManaFurnaceMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public ManaFurnaceMenu(int id, Inventory inv, BlockEntity entity, ContainerData data){
        super(ModMenuTypes.MANA_FURNACE_MENU.get(), id);
        checkContainerSize(inv, 3);
        blockEntity = (ManaFurnaceBlockEntity) entity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.MANA_FURNACE.get());
    }
