package net.juliantexo.magicprogression.screen.renderer;
...
public class EnergyInfoArea extends InfoArea {
    ...
    public List<Component> getTooltips() {
        return List.of(Component.literal(energy.getEnergyStored()+"/"+energy.getMaxEnergyStored()+" Mana"));
    }
